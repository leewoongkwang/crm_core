# Generated by Django 5.2.1 on 2025-05-30 12:49
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user_type', models.CharField(choices=[('planner', '설계사'), ('manager', '지점장'), ('branch', '본사관리자')], max_length=16)),
                ('is_subscribed', models.BooleanField(default=False)),
                ('subscription_plan', models.CharField(blank=True, max_length=16, null=True)),
